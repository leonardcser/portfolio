    ...
    <>
      <section id="about">
        ...
        <p>
          ...
          unique combination of skills to the table. With expertise in data
          analytics, software and web development, UI/UX design, and
          entrepreneurship, I&apos;m able to see the big picture while also
          ...
          items={[
            {
              ...
              description:
                "My time at EPFL was instrumental in shaping my career path. My passion for computer science was ignited here.",
              date: "2019-2023",
            },
            {
              ...
              description:
                "During my studies, I was a member of the EPFL Entrepreneur Club. I was able to learn from and collaborate with other entrepreneurs.",
              date: "2020-2023",
            },
            {
              ...
              title: "Scrapeout",
              description:
                "With interest in data analytics, I founded Scrapeout, a data analytics company. I was able to learn about entrepreneurship and the challenges of running a business.",
              date: "2020-2023",
            },
          ]}
        />
